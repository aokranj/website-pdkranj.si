...
<div class="style-15 <?php echo ! empty( $position ) ? $position : ''; ?>
 <?php echo apply_filters( 'wp_dark_mode/switch_label_class', 'wp-dark-mode-side-toggle-wrap wp-dark-mode-ignore' ); ?>">

    <div class="wp-dark-mode-side-toggle wp-dark-mode-toggle wp-dark-mode-switcher wp-dark-mode-ignore">

        <svg class="wp-dark-mode-ignore mode-light width-20px height-20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            <path class="wp-dark-mode-ignore" id="Path_6" data-name="Path 6" d="M22,23.455A4.546,4.546,0,1,0,26.545,28,4.547,4.547,0,0,0,22,23.455Zm-9.091,5.455h1.818a.909.909,0,1,0,0-1.818H12.909a.909.909,0,0,0,0,1.818Zm16.364,0h1.818a.909.909,0,0,0,0-1.818H29.273a.909.909,0,1,0,0,1.818Zm-8.182-10v1.818a.909.909,0,1,0,1.818,0V18.909a.909.909,0,0,0-1.818,0Zm0,16.364v1.818a.909.909,0,1,0,1.818,0V35.273a.909.909,0,1,0-1.818,0ZM16.536,21.254a.906.906,0,1,0-1.282,1.282l.964.964A.906.906,0,0,0,17.5,22.218ZM27.782,32.5A.906.906,0,1,0,26.5,33.782l.964.964a.906.906,0,1,0,1.282-1.282Zm.964-9.964a.906.906,0,1,0-1.282-1.282l-.964.964A.906.906,0,0,0,27.782,23.5ZM17.5,33.782A.906.906,0,1,0,16.218,32.5l-.964.964a.906.906,0,0,0,1.282,1.282l.964-.964Z" transform="translate(-12 -18)" fill="#fff"/>
        </svg>
        ...
        <span class="wp-dark-mode-ignore"><?php _e( 'Toggle Dark Mode', 'wp-dark-mode' ); ?></span>
    </div>
    ...
    <div class="wp-dark-mode-side-toggle wp-dark-mode-font-size-toggle wp-dark-mode-ignore">
        ...
        <span class="wp-dark-mode-ignore"><?php _e( 'Toggle Font Size', 'wp-dark-mode' ); ?></span>
    </div>
