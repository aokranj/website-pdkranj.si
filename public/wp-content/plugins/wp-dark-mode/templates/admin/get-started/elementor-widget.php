...
<div class="wp-dark-mode-elementor-doc">
    <h2><?php esc_html_e('How to display Dark Mode Switch Button using Elementor Widget', 'wp-dark-mode'); ?></h2>
    ...
    <ul class="doc-section">
        ...
        <li>
            <h3> <i class="dashicons dashicons-saved"></i> <?php esc_html_e('Add "Dark Mode Switch" widget from "Basic" category', 'wp-dark-mode'); ?></h3>
            <img src="<?php echo WP_DARK_MODE_ASSETS.'/images/elementor/step-1.png'; ?>" alt="step-2">
        </li>

        <li>
            <h3> <i class="dashicons dashicons-saved"></i> <?php esc_html_e('Choose button style from widget settings and you are done', 'wp-dark-mode'); ?></h3>
