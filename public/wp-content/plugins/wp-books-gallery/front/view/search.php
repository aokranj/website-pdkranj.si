        ...
        if ( $wbg_display_search_category ) {
          ...
          <div class="wbg-search-item">
            ...
            foreach ( $wbg_book_categories as $book_category ) {
                ?>
                  <option value="<?php 
                esc_attr_e( $book_category->name );
                ?>" <?php 
                selected( htmlspecialchars( $wbg_category_s ), addslashes( $book_category->name ) );
                ?>><?php 
                ...
                if ( $loterms ) {
                    foreach ( $loterms as $key => $loterm ) {
                        ?>
                      <option value="<?php 
                        esc_attr_e( $loterm->name );
                        ?>" <?php 
                        selected( htmlspecialchars( $wbg_category_s ), addslashes( $loterm->name ) );
                        ?>>- <?php 
