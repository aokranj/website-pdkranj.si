...
<div id="wph-wrap-all" class="wrap wbg-search-panel-settings">
    ...
    <div class="settings-banner">
        <h2><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;<?php _e('Search Panel Settings', WBG_TXT_DOMAIN); ?></h2>
    </div>
    ...
    <div class="wbg-wrap">
        ...
        <div class="wbg_personal_wrap wbg_personal_help" style="width: 72%; float: left;">
            
            <div class="tab-content">
                <?php 
                switch ( $tab ) {
                    case 'styles':
                        include WBG_PATH . 'admin/view/partial/search-styles-settings.php';
                        break;
                    default:
                        include WBG_PATH . 'admin/view/partial/search-content-settings.php';
                        break;
                } 
                ?>
            </div>
